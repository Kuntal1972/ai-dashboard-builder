const AppState = {
  ...
  columns:        [],
  colTypes:       {},
  datasets:       [],   // multi-file mode: array of { id, fileName, rawData, columns, colTypes }
  conversation:   [],
  currentSpec:    null,
  filters:        {},
  fileName:       '',
    ...
    AppState.config = {
      ...
      chart: {
        ...
        colorScales: {
          ...
          viridis:'Viridis', sunset:'RdYlBu', plotly:'Portland'
        },
      ...
      ui: {
        previewRows: 100,
        sampleRowsForAnalysis: 300,
        sampleUniqueValues: 8,
        maxFilterUniqueValues: 60,
